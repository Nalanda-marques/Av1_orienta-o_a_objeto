...
public class Program
{
	public static void Main()
	{
		...
		whatsAppProfessor.EnviarMensagem("+5511965026358", mensagem);
		
		//Enviando mensagem de vídeo
		instaAluno.EnviarMensagem("+5511965026358", mensagemVideo);
		
		
		MensagemMultimidia mensagemNalanda = mensagemVideo;
		mensagemNalanda.Mensagem = "Olá, Nalanda!";
		
		ICanal facebook = new Facebook();
		facebook.EnviarMensagem("usuarioDaNalanda", mensagemNalanda);
